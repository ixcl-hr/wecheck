...
class UtilService {
  ...
  static Future<void> reToken() async {
    ...
    if (token != null && token.isNotEmpty) {
      ...
      List<dynamic>? langList = profile.listLanguage;
      setSharedPreferencesWithPrefs(prefs, "listLanguage", langList);
    }
  }
  ...
  static Future<List<dynamic>?> getListLanguage() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getString('listLanguage') as List<dynamic>?;
  }

  static Future<bool> isHasLang(String lang) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<dynamic>? langList = prefs.getString('langList') as List<dynamic>?;
  ...
  static Future<Position?> getCurrentLocation(Profile? profile) async {
    try {
      ...
      print("util service getCurrentLocation function error line 343,$e");
      //resultText = e;
