...
class HomeScreenState extends State<HomeScreen> {
  ...
  getProfile() async {
    ...
    menuLangList = await UtilService.getListLanguage();

    if (profile != null) {
      setState(() {
        profile = profile;
        menuLangList = profile!.listLanguage;
                ...
                Positioned(
                  ...
                  child: !isCanchangeLang
                      ...
                      : PopupMenuButton(itemBuilder: (context) {
                          if (menuLangList != null) {
                            return List.generate(
                              menuLangList!.length,
                              (index) => PopupMenuItem(
                                value: index,
                                child: Text(
                                  menuLangList![index].toString().split('|')[0],
                                  style: const TextStyle(
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                  ...
                  //       ),
                  //       PopupMenuItem(
                  //         child: const Text("မြန်မာ(myanmar)",
                  //             style: TextStyle(
                  //               fontWeight: FontWeight.bold,
                  //             )),
                  //         onTap: () async {
