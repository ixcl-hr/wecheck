                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Text(
                            '${UtilService.getTextFromLang("date", "วันที่")} $dateSelectedLabel',
                                                  ...
                                                  children: [
                                                    Text(
                                                      workType1Scan.isEmpty
                                                          ...
                                                          : '${UtilService.getTextFromLang("in", "เข้า")} ${convertTimeLabel(workType1Scan[0].wsstarttime1 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                    Text(
                                                      workType1Scan.isEmpty ||
                                                              workType1Scan[0]
                                                                  ...
                                                                  null
                                                          ? ''
                                                          : '${UtilService.getTextFromLang("in", "เข้า")} ${convertTimeLabel(workType1Scan[0].wsstarttime2 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                  ],
                                                  ...
                                                  children: [
                                                    Text(
                                                      workType1Scan.isEmpty
                                                          ...
                                                          : '${UtilService.getTextFromLang("out", "ออก")} ${convertTimeLabel(workType1Scan[0].wsendtime1 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                    Text(
                                                      workType1Scan.isEmpty ||
                                                              workType1Scan[0]
                                                                  ...
                                                                  null
                                                          ? ''
                                                          : '${UtilService.getTextFromLang("out", "ออก")} ${convertTimeLabel(workType1Scan[0].wsendtime2 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                  ],
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      workType1Scan.isEmpty
                                                          ? '${UtilService.getTextFromLang("in", "เข้า")} -'
                                                          : '${UtilService.getTextFromLang("in", "เข้า")} ${convertDateLabel(workType1Scan[0].startdate1 ?? "")} ${convertTimeLabel(workType1Scan[0].starttime1 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                    Text(
                                                      workType1Scan.isEmpty
                                                          ? '${UtilService.getTextFromLang("in", "เข้า")} -'
                                                          : '${UtilService.getTextFromLang("in", "เข้า")} ${convertDateLabel(workType1Scan[0].startdate2 ?? "")} ${convertTimeLabel(workType1Scan[0].starttime2 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                  ],
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      workType1Scan.isEmpty
                                                          ? '${UtilService.getTextFromLang("out", "ออก")} -'
                                                          : '${UtilService.getTextFromLang("out", "ออก")} ${convertDateLabel(workType1Scan[0].enddate1 ?? "")} ${convertTimeLabel(workType1Scan[0].endtime1 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                    Text(
                                                      workType1Scan.isEmpty
                                                          ? '${UtilService.getTextFromLang("out", "ออก")} -'
                                                          : '${UtilService.getTextFromLang("out", "ออก")} ${convertDateLabel(workType1Scan[0].enddate2 ?? "")} ${convertTimeLabel(workType1Scan[0].endtime2 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                  ],
                                                  ...
                                                  children: [
                                                    Text(
                                                      workType2OT.isEmpty
                                                          ...
                                                          : '${UtilService.getTextFromLang("start", "เริ่ม")} ${convertDateLabel(workType2OT[0].startdate1 ?? "")} ${convertTimeLabel(workType2OT[0].starttime1 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                  ],
                                                  ...
                                                  children: [
                                                    Text(
                                                      workType2OT.isEmpty
                                                          ...
                                                          : '${UtilService.getTextFromLang("end", "สิ้นสุด")} ${convertDateLabel(workType2OT[0].enddate1 ?? "")} ${convertTimeLabel(workType2OT[0].endtime1 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                  ],
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      workType3Absent.isEmpty
                                                          ? '${UtilService.getTextFromLang("start", "เริ่ม")} -'
                                                          : '${UtilService.getTextFromLang("start", "เริ่ม")} ${convertDateLabel(workType3Absent[0].startdate1 ?? "")} ${convertTimeLabel(workType3Absent[0].starttime1 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                  ],
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      workType3Absent.isEmpty
                                                          ? '${UtilService.getTextFromLang("end", "สิ้นสุด")} -'
                                                          : '${UtilService.getTextFromLang("end", "สิ้นสุด")} ${convertDateLabel(workType3Absent[0].enddate1 ?? "")} ${convertTimeLabel(workType3Absent[0].endtime1 ?? "")}',
                                                      style: const TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                  ],
                                                    ...
                                                    children: [
                                                      Text(
                                                        workType4Miss.isEmpty
                                                            ? ''
                                                            : '${UtilService.getTextFromLang("in", "เข้า")} ${convertTimeLabel(workType4Miss[0].wsstarttime1 ?? "")}',
                                                        style: const TextStyle(
                                                            fontSize: 14),
                                                      ),
                                                      Text(
                                                        workType4Miss.isEmpty ||
                                                                workType4Miss[0]
                                                                    ...
                                                                    null
                                                            ? ''
                                                            : '${UtilService.getTextFromLang("in", "เข้า")} ${convertTimeLabel(workType4Miss[0].wsstarttime2 ?? "")}',
                                                        style: const TextStyle(
                                                            fontSize: 14),
                                                      ),
                                                    ],
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        workType4Miss.isEmpty
                                                            ? ''
                                                            : '${UtilService.getTextFromLang("out", "ออก")} ${convertTimeLabel(workType4Miss[0].wsendtime1 ?? "")}',
                                                        style: const TextStyle(
                                                            fontSize: 14),
                                                      ),
                                                      Text(
                                                        workType4Miss.isEmpty ||
                                                                workType4Miss[0]
                                                                    ...
                                                                    null
                                                            ? ''
                                                            : '${UtilService.getTextFromLang("out", "ออก")} ${convertTimeLabel(workType4Miss[0].wsendtime2 ?? "")}',
                                                        style: const TextStyle(
                                                            fontSize: 14),
                                                      ),
                                                    ],
                                                    ...
                                                    children: [
                                                      Text(
                                                        workType4Miss.isEmpty
                                                            ...
                                                            : '${workType4Miss[0].missinghour} ${UtilService.getTextFromLang("hour_short_type", "ชม.")}',
                                                        style: const TextStyle(
                                                            fontSize: 14),
                                                      ),
                                                    ],
